...
Action: 0-3    which lane gets green next
...
#  Hyperparameters 
STATE_SIZE    = 18
ACTION_SIZE   = 4
MEMORY_SIZE   = 10_000
BATCH_SIZE    = 64
...
class DQNAgent:
    ...
    #  Network 
    ...
    #  Decision 
    def act(self, state):
        """
        Returns (action_int, decision_mode_str)
        Priority: ambulance > pedestrian > RL > rule-based
        """
        amb = state[8:12]
        ped = state[12:16]

        # Hard override: ambulance
        if any(a > 0.5 for a in amb):
            return int(np.argmax(amb)), 'ambulance_override'

        # Soft override: pedestrian waiting
        if any(p > 0.5 for p in ped):
            return int(np.argmax(ped)), 'pedestrian_override'

        # Starvation guard  any lane ignored 4 cycles gets green
        ...
        if TF_AVAILABLE and self.model:
            ...
            return int(np.argmax(q)), 'rl_exploit'
    ...
    #  Learning 
    ...
    #  Reward 
    ...
    #  Status 
    def get_status(self):
